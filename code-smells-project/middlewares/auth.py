...
POLITICAS_PADRAO = {
    "index": PUBLICA,
    "health_check": PUBLICA,
    "listar_produtos": PUBLICA,
    "buscar_produtos": PUBLICA,
    "buscar_produto": PUBLICA,
    "criar_usuario": PUBLICA,
    "login": PUBLICA,
    "criar_pedido": PUBLICA,

    "criar_produto": ADMIN,
    "atualizar_produto": ADMIN,
    "deletar_produto": ADMIN,
    "listar_usuarios": ADMIN,
    "buscar_usuario": ADMIN,
    "listar_todos_pedidos": ADMIN,
    "listar_pedidos_usuario": AUTENTICADA,
    "atualizar_status_pedido": ADMIN,
    "relatorio_vendas": ADMIN,
